...
<div class="bg-yellow-400 h-screen overflow-hidden flex items-center justify-center">
  <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    ...
    <form class="p-12 md:p-24" action="<?= PATH ?>index.php?page=login" method="post">
      ...
      <button type="submit" name="submit" class="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
